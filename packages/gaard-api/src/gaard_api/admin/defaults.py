...
DEFAULT_CONVERSATION_CONTEXT_CLASSIFICATION_SYSTEM_PROMPT = CONTEXT_DECISION_SYSTEM_PROMPT
DEFAULT_CONVERSATION_CONTEXT_CLASSIFICATION_USER_PROMPT = CONTEXT_DECISION_USER_PROMPT
...
DEFAULT_PROMPTS = [
    ...
    },
    {
        ...
        "description": (
            ...
            "of the full context since the last new topic."
        ),
    ...
    {
        "prompt_key": "conversation_context_summary",
        "name": "Conversation context summary",
        "description": "Compresses the current context and follow-up into one standalone sentence.",
